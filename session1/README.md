...
---
To actually be able to display anything with Three.js, we need three things: A scene, a
<br> camera, and a renderer so we can render the scene with the camera.
<br>

...
// MATERIAL 1:
var material = new THREE.MeshBasicMaterial( { color: "#EEB4B4" } );
...
//MATERIAL 9 (texture)
var material1 = new THREE.MeshBasicMaterial( { map:new THREE.TextureLoader().load('textures/wood.gif') } );
...
var mesh11 = new THREE.Mesh( geometry, material5 );
